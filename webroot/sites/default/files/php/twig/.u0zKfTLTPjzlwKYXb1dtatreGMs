...
/* {# inline_template_start #}{{ field_slider_image }}<div class="caption">{{ body }}</div> */
class __TwigTemplate_ebf660778180d7a9987b909e0b5a4841c8648082f4d7b160cf2a1e372c65f78e extends Twig_Template
{
    ...
    {
        return "{# inline_template_start #}{{ field_slider_image }}<div class=\"caption\">{{ body }}</div>";
    }
